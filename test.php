...
<html lang="en">
    ...
    <body class=" bg-white" style="background-image: url(assets/img/test3.jpg)" >
        ...
        <div class="container" style="background-color: #282828 ">
			...
			<div class="container">
			<div class="row">
				<div class="col-xl-12 col-sm-12" style="background-color: #FFFFFF;border-radius: 15px" align="center">
                    <p>&nbsp;</p>
                    
                    
				
					<h3 class="wow fadeInDown s6 text-primary"><i class="fas fa-book"></i>&nbsp;บทที่ <?php echo $row['l_lesson'] ?> <?php echo $row['l_namelesson'] ?></h3>
					<hr style="color: #000000">
					<p><?php echo $row['l_detail'] ?></p>
						
                    <div class="col-xl-12 col-sm-12" >
					<div class="container">
					<div class="row">
                    <iframe src="<?php echo $row['l_linkpdf'] ?>" class="embed-responsive"  width="650" height="900"  scrolling="Yes"></iframe>
				</div>
			</div>
		</div>
