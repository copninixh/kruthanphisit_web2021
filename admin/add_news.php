                ...
                <div class="panel-body">
                    ...
                    <form action="process/add_news.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control m-b-5" placeholder="ชื่อข่าว"
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-10">
                                <textarea class="ckeditor" id="editor1" name="n_detail" rows="20"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row m-b-15 d-none">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control m-b-5" value="<?php echo date("d") ?>"
                        ...
                        <div class="form-group row m-b-15 d-none">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control m-b-5" value="<?php echo date("m") ?>"
                                    name="n_month" >
                        ...
                        <div class="form-group row m-b-15 d-none">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control m-b-5" value="<?php echo date("Y") ?>"
                                    name="n_year" >
                        ...
                        <input type="submit" class="btn btn-green w-100" style="color: white" name="add_news"
                            value="เพิ่มข่าว">
                    </form>
                </div>
            </div>
